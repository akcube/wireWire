...
class _TemperatureScreenState extends State<TemperatureScreen> {
  ...
  void updateStats() {
    ...
    setState(() {
      double? a = (separateRecordings[currSession].map((e) => e.temperature))
          .reduce((a, b) {
        return min(a!, b!);
      });
      double? b = (separateRecordings[currSession].map((e) => e.temperature))
          .reduce((a, b) {
        return max(a!, b!);
      });
      double? c =
          separateRecordings[currSession].map((e) => e.temperature!).average;
      sessionData = [a!, b!, c];
    });
  }
