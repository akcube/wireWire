...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  final thingSpeakController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    final thingSpeakChannelField = TextFormField(
        style: const TextStyle(color: Colors.white),
        autofocus: false,
        controller: thingSpeakController,
        keyboardType: TextInputType.number,
        validator: (value) {
          if (value!.isEmpty) {
            return ("Please Enter Your ThingSpeak Channel ID");
          }
          return null;
        },
        onSaved: (value) {
          thingSpeakController.text = value!;
        },
  ...
  postDetailsToFirestore() async {
    ...
    userModel.thingSpeakChannel = thingSpeakController.text;
